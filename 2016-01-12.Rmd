...
> $$\text{Estimator} \pm \text{"2"} \sqrt{\text{Standard Error}}$$

> "Standard Error" is short for "the standard deviation of the estimator".
...
* Equivalent: $Y_{ij} = \mu_i + \varepsilon_{ij}$ with $\varepsilon_{ij}\sim
N(0, \sigma_i^2)$ and $i\in\{1,2\}$
...
>* There is \textit{no} reliable method to formally test the difference
